...
class ThemeColors extends ThemeExtension<ThemeColors> {
  ...
  static get light => ThemeColors(
        ...
        playButtonFocusColor: AppColors.blue.withOpacity(0.3),
        favoriteButtonIconColor: AppColors.red,
        favoriteButtonFocusColor: AppColors.blue.withOpacity(0.3),
        tvSeriesDialogDropdownColor: AppColors.white,
        navigationRailBackgroundColor: AppColors.white,
        navigationRailSelectedIconColor: AppColors.red,
        navigationRailUnselectedIconColor: AppColors.black,
        bottomNavigationBarBackgroundColor: AppColors.white,
        bottomNavigationBarSelectedItemColor: AppColors.red,
        bottomNavigationBarUnselectedItemColor: AppColors.black,
        searchFieldFillColor: AppColors.white,
        searchFieldIconColor: AppColors.black,
        ...
        settingsItemIcon: AppColors.black,
        formFieldBorder: AppColors.lighterGrey,
